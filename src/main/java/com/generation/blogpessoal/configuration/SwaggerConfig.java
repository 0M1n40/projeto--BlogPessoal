	...
	OpenAPI springBlogPessoalAPI() {
		return new OpenAPI()
				.info(new Info().title("Projeto Blog Pessoal").description("Projeto Blog Pessoal - Generation Brasil")
						...
						.contact(new Contact().name("Mina Monteiro").url("https://www.linkedin.com/in/mina-monteiro/")
								.email("minaimmonteiro@gmail.com")))
				.externalDocs(new ExternalDocumentation().description("Github").url("https://github.com/0M1n40"));
